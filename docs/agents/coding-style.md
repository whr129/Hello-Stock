...
Prefer `snake_case` for functions, variables, and modules, `PascalCase` for classes, and explicit domain names such as `RuntimeTraceService`, `MemoryConsolidationService`, or `MarketSubagent`.
